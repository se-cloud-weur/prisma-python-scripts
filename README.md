...
This script will calculate the amount of assets you have in a prisma cloud environnment to determine what the costs would look like for Cortex Cloud workloads. It delivers output into the console with python and to a csv file called prisma_assets.csv
